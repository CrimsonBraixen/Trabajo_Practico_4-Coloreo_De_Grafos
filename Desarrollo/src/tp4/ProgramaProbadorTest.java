...
public class ProgramaProbadorTest {
	...
	public void programaProbadorGrafo1000Nodos50AdyacenciaAleatorio() throws IOException{
		ProgramaProbador pp = new ProgramaProbador("Pruebas\\in\\grafoRegular50.in", "Pruebas\\out\\grafoRegular50Aleatorio.out");
		Assert.assertTrue(pp.probarSiLaSalidaEsCorrecta());
	}
	
	@Test
	public void programaProbadorGrafo1000Nodos50AdyacenciaWelshPowell() throws IOException{
		ProgramaProbador pp = new ProgramaProbador("Pruebas\\in\\grafoRegular50.in", "Pruebas\\out\\grafoRegular50WelshPowell.out");
		Assert.assertTrue(pp.probarSiLaSalidaEsCorrecta());
	}
	
	@Test
	public void programaProbadorGrafo1000Nodos50AdyacenciaMatula() throws IOException{
		ProgramaProbador pp = new ProgramaProbador("Pruebas\\in\\grafoRegular50.in", "Pruebas\\out\\grafoRegular50Matula.out");
		Assert.assertTrue(pp.probarSiLaSalidaEsCorrecta());
	}
